...
Read the full tutorial [here](https://book.dojoengine.org/).
...
Use the `start_game` function to begin. Hero will be spawn on a 3x3 game board with monsters and items. Monsters are enemies you can fight, and items provide benefits (like healing).
